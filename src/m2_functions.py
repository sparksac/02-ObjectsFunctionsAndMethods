...
def turtle5():
    ...
    tony.speed = 8
    tony.pen = rg.Pen('green',20)

    izzy = rg.SimpleTurtle('turtle')
    izzy.speed = 15
    izzy.pen = rg.Pen('purple', 25)

    tony.forward(200)
    tony.draw_regular_polygon(6,100)
    tony.draw_regular_polygon(5,100)

    izzy.right(180)
    izzy.forward(300)
    izzy.begin_fill()
    izzy.draw_square(600)
    izzy.end_fill()
    izzy.forward(200)
    izzy.draw_regular_polygon(12,50)
